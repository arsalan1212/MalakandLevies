...
public class CriminalCompleteDetail extends AppCompatActivity {

    private static final String image_url="http://ourwebacademy.com/levies/admin/criminal_images/";
    ImageView imageView_criminal;
    TextView tv_criminal_name,tv_crime_no_record;
    EditText f_name, cnic, phone_no, district, address, status, status_details,comments;
    private ArrayList<CriminalModel> arrayList_criminal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_criminal_complete_detail);
        Toolbar toolbar = (Toolbar) findViewById(R.id.criminal_detail_toolbar);
    ...
    //setting and getting criminal detail
    private void getAndSetCriminalDetail() {

        f_name.setText(arrayList_criminal.get(position).getFather_name());
        cnic.setText(arrayList_criminal.get(position).getNic());
        phone_no.setText(arrayList_criminal.get(position).getPhone_no());
        district.setText(arrayList_criminal.get(position).getDistrict());
        address.setText(arrayList_criminal.get(position).getAddress());
        status.setText(arrayList_criminal.get(position).getStatus());
        status_details.setText(arrayList_criminal.get(position).getStatus_detail());
        comments.setText(arrayList_criminal.get(position).getComments());

    }

    private void getIntentData() {
        Intent intent=getIntent();
        String name=intent.getStringExtra("criminal_name");
        String image=intent.getStringExtra("criminal_image");
        position = intent.getIntExtra("position",0);

        arrayList_criminal= (ArrayList<CriminalModel>) intent.getSerializableExtra("criminal_arraylist");
        arraylist_crime_detail= (ArrayList<CrimeModel>) intent.getSerializableExtra("crime_detail_arraylist");

        //setting criminal name and profile image
        tv_criminal_name.setText(name);
        Picasso.with(CriminalCompleteDetail.this).load(image_url+image).into(imageView_criminal);
    }
// initializing the views
    private void initView() {

        tv_criminal_name= (TextView) findViewById(R.id.tv_criminal_nm);
        imageView_criminal= (ImageView) findViewById(R.id.criminal_image);
        f_name = (EditText) findViewById(R.id.ef_name);
        cnic = (EditText) findViewById(R.id.ecnic);
        phone_no = (EditText) findViewById(R.id.ephone_no);
        ...
        status_details = (EditText) findViewById(R.id.estatus_details);
    ...
    public void BackButton(View view){
        if(Build.VERSION.SDK_INT>=Build.VERSION_CODES.LOLLIPOP){
            ...
            Intent intent=new Intent(CriminalCompleteDetail.this,show_criminal_list.class);
